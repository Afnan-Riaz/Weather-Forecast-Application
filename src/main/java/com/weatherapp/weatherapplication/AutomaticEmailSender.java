...
//        String body = "The Air Quality Index (AQI) in "  + forecast.location()+ " is currently " + forecast.airQualityIndex() + ", which means air quality is very poor. Please take necessary precautions.";
//
//        SendEmail emailSender = new SendEmail(username, password);
//
//        try {
